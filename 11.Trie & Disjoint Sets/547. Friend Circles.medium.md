...
###Refer: https://leetcode-cn.com/problems/friend-circles/solution/union-find-suan-fa-xiang-jie-by-labuladong/
```
...
###Refer: https://leetcode-cn.com/problems/friend-circles/solution/peng-you-quan-by-leetcode/
```
    public int findCircleNum(int[][] M) {
